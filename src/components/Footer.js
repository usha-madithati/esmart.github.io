          ...
          <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav class="list-none mb-10">
                ...
                <li>
                  <Link to="/#about-us" class="text-gray-600 hover:text-gray-800">
                    About Us
                  </Link>
                </li>
                <li>
        ...
        <div class="bg-gray-100">
          <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            ...
            <span class="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
              <Link to="https://www.facebook.com/profile.php?id=61561813920306" class="text-gray-500">
                <svg
                  fill="currentColor"
              ...
              <Link to="https://www.instagram.com/smart_saver_2k24/" class="ml-3 text-gray-500">
                <svg
                  fill="none"
                  stroke="currentColor"
                  stroke-linecap="round"
