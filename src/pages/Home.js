    ...
    <>     
      ...
      <div className="min-h-screen bg-gray-100 flex flex-col items-center">
        <main className="flex-grow w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <section className="relative bg-gradient-to-r from-sky-400 to-emerald-600 text-white py-24">
            <div className="absolute inset-0 bg-cover bg-center opacity-30" style={{ backgroundImage: "url('your-image-url.jpg')" }}></div>
            <div className="relative text-center">
              <h1 className="text-5xl font-bold">SMART SAVER</h1>
              <p className="text-xl mt-4">STAY FRESH</p>
              <button onClick={handleScanNowClick} className="mt-8 px-8 py-3 bg-green-500 text-white rounded-full text-lg font-semibold hover:bg-green-600 transition duration-300">
                SCAN NOW
              </button>
            </div>
          </section>
          ...
          <section className="mt-16" id="about-us" ref={aboutUsRef}>
            ...
            <div className="flex flex-col md:flex-row justify-around items-center mt-8 space-y-8 md:space-y-0">
              <Link to="/user/login" >
                <div className="flex flex-col items-center text-center hover:scale-105 transform transition-all duration-300">
                  <img
              ...
              <Link to="/scanqr" > <div className="flex flex-col items-center text-center hover:scale-105 transform transition-all duration-300">
                <img
              ...
              <Link to="/user/notifications" ><div className="flex flex-col items-center text-center hover:scale-105 transform transition-all duration-300">
                <img
          ...
          <section class="text-gray-600 body-font">
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
              <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center hover:scale-105 transform transition-all duration-300">
          ...
          <section class="text-gray-600 body-font">
            <div class="container mx-auto flex px-5 md:flex-row flex-col items-center">
              <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center hover:scale-105 transform transition-all duration-300">
